...
% Slide 4b: ESG Dimensions Chart
\begin{frame}{ESG Dimensions}
\begin{center}
\includegraphics[width=0.55\textwidth]{../charts/04_esg_dimensions/chart.pdf}
\end{center}
\bottomnote{ESG factors form the foundation of sustainable investing}
\end{frame}
...
% Slide 5b: Innovation Diamond Chart
\begin{frame}{The Innovation Diamond}
\begin{center}
\includegraphics[width=0.55\textwidth]{../charts/01_diamond_overview/chart.pdf}
\end{center}
\bottomnote{Expansion then convergence in innovation}
\end{frame}
...
% Slide 6b: ESG Exploration Chart
\begin{frame}{ESG Dimension Exploration}
\begin{center}
\includegraphics[width=0.55\textwidth]{../charts/04_esg_dimensions/chart.pdf}
\end{center}
\bottomnote{Unsupervised methods discover key ESG dimensions}
\end{frame}
...
% Slide 7b: Feature Extraction Chart
\begin{frame}{Feature Extraction Process}
\begin{center}
\includegraphics[width=0.7\textwidth]{../charts/05_feature_extraction/chart.pdf}
\end{center}
\bottomnote{Raw data transforms into predictive features through systematic engineering}
\end{frame}
...
% Slide 8b: Neural Network Architecture Chart
\begin{frame}{Neural Network Architecture}
\begin{center}
\includegraphics[width=0.6\textwidth]{../charts/16_neural_network_arch/chart.pdf}
\end{center}
\bottomnote{Interconnected neurons learn abstract representations}
\end{frame}
...
% Slide 9b: Idea Generation Chart
\begin{frame}{Idea Generation at Scale}
\begin{center}
\includegraphics[width=0.7\textwidth]{../charts/06_idea_generation/chart.pdf}
\end{center}
\bottomnote{LLMs and generative models create thousands of novel combinations}
\end{frame}
...
% Slide 11b: Peak Pool Chart
\begin{frame}{Peak: 5,000 Possibilities}
\begin{center}
\includegraphics[width=0.7\textwidth]{../charts/07_peak_pool/chart.pdf}
\end{center}
\bottomnote{The peak represents maximum divergence before convergence begins}
\end{frame}
...
% Slide 15b: ESG Clustering Chart
\begin{frame}{ESG Strategy Clusters}
\begin{center}
\includegraphics[width=0.7\textwidth]{../charts/08_clustering_esg/chart.pdf}
\end{center}
\bottomnote{Clustering reveals natural groupings in ESG investment approaches}
\end{frame}
...
% Slide 16b: Classification Tiers Chart
\begin{frame}{ESG Classification Tiers}
\begin{center}
\includegraphics[width=0.7\textwidth]{../charts/09_classification_tiers/chart.pdf}
\end{center}
\bottomnote{Classification separates companies into tiers based on ESG performance}
\end{frame}
...
% Slide 17b: Validation Metrics Chart
\begin{frame}{Cross-Validation Performance}
\begin{center}
\includegraphics[width=0.7\textwidth]{../charts/10_validation_metrics/chart.pdf}
\end{center}
\bottomnote{Cross-validation provides robust estimates of model performance}
\end{frame}
...
% Slide 20b: Structured Output Reliability Chart
\begin{frame}{Output Reliability Framework}
\begin{center}
\includegraphics[width=0.7\textwidth]{../charts/17_structured_output_reliability/chart.pdf}
\end{center}
\bottomnote{JSON schema validation ensures consistent, reliable AI outputs}
\end{frame}
...
% Slide 21b: Efficient Frontier Chart
\begin{frame}{ESG Efficient Frontier}
\begin{center}
\includegraphics[width=0.7\textwidth]{../charts/18_efficient_frontier/chart.pdf}
\end{center}
\bottomnote{Portfolio optimization balances ESG constraints with return objectives}
\end{frame}
