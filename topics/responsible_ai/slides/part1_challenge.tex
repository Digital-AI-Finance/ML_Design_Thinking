...
% Slide 9a: Bias Entry Points - ML Pipeline
\begin{frame}[t]{Where Bias Enters: The ML Pipeline}
\begin{columns}[T]
\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Data and Features}}
...
\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Model and Deployment}}

\small
\textcolor{mlpurple}{\textbf{3. Model Training}}
\begin{itemize}
\item Optimization for accuracy $\neq$ fairness
...
\item Feedback loops amplify bias
...
\vspace{0.5em}
\begin{tcolorbox}[colback=mllavender!30, colframe=mlpurple]
\textbf{Key Insight:} Bias enters at all pipeline stages - requires monitoring at each transformation point
\end{tcolorbox}

\bottomnote{Multi-stage bias entry necessitates comprehensive auditing at data, features, training, and deployment}
\end{frame}

% Slide 9b: Ethical Frameworks for AI
\begin{frame}[t]{Ethical Frameworks for Evaluating AI Systems}
\begin{columns}[T]
\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Outcome-Focused}}

\small
\textcolor{mlorange}{\textbf{Consequentialist}}
\begin{itemize}
\item Maximize benefit, minimize harm
\item \textbf{Ask:} Does system increase welfare?
\end{itemize}
...
\item \textbf{Ask:} Does it respect human dignity?
\end{itemize}

\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Character-Focused}}

\small
\textcolor{mlpurple}{\textbf{Virtue Ethics}}
\begin{itemize}
\item Cultivate wisdom and fairness
\item \textbf{Ask:} What would a fair person do?
\end{itemize}

\vspace{0.3cm}
\textcolor{mlorange}{\textbf{Care Ethics}}
\begin{itemize}
\item Address vulnerability in context
\item \textbf{Ask:} Who is most vulnerable?
\end{itemize}
\end{columns}

\vspace{0.5em}
\begin{tcolorbox}[colback=mllavender!30, colframe=mlpurple]
\textbf{Key Insight:} No single framework sufficient - combine perspectives for robust ethical evaluation
\end{tcolorbox}

\bottomnote{Ethical frameworks provide complementary lenses for evaluating fairness in AI systems}
\end{frame}

% Slide 10a: Who Has Power in AI Systems
\begin{frame}[t]{Power in AI Systems: Who Controls What}
\begin{columns}[T]
\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Those With Power}}

\small
\textcolor{mlorange}{\textbf{Tech Companies}}
\begin{itemize}
\item Control system design
\item Set defaults and constraints
\end{itemize}

\textcolor{mlblue}{\textbf{Governments}}
\begin{itemize}
\item Regulatory authority
\item Enforcement power
\end{itemize}

\textcolor{mlpurple}{\textbf{Privileged Groups}}
\begin{itemize}
...
\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Key Stakeholders}}

\small
\begin{itemize}
\item \textbf{Users:} Direct interaction
\item \textbf{Developers:} Technical choices
\item \textbf{Deployers:} Operational control
\item \textbf{Communities:} Indirect impact
\end{itemize}
\end{columns}

\vspace{0.5em}
\begin{tcolorbox}[colback=mllavender!30, colframe=mlpurple]
\textbf{Key Insight:} Power concentration in tech companies shapes system design - stakeholder mapping is essential
\end{tcolorbox}

\bottomnote{Understanding power distribution enables targeted interventions for fairer AI systems}
\end{frame}

% Slide 10b: Who Lacks Power in AI Systems
\begin{frame}[t]{Power Asymmetries: Who Bears the Harm}
\begin{columns}[T]
\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Those Without Power}}

\small
\textcolor{mlorange}{\textbf{End Users}}
\begin{itemize}
\item Limited choice, no opt-out
\item Information asymmetry
\end{itemize}

\textcolor{mlblue}{\textbf{Marginalized Groups}}
\begin{itemize}
\item Underrepresented in data
\item Higher error rates, less recourse
\end{itemize}

\textcolor{mlpurple}{\textbf{Future Generations}}
\begin{itemize}
\item No voice in current decisions
\item Inherit path dependencies
\end{itemize}

\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Consequences}}

\small
\textcolor{mlorange}{\textbf{Impact of Imbalance:}}
\begin{itemize}
...
\vspace{0.5cm}
\textcolor{mlred}{\Large\textbf{Responsible AI:}}\\
\vspace{0.2cm}
...
\vspace{0.5em}
\begin{tcolorbox}[colback=mllavender!30, colframe=mlpurple]
\textbf{Key Insight:} Fairness requires centering those who bear harm, not those who hold power
\end{tcolorbox}

\bottomnote{Stakeholder identification precedes harm prevention - invisible constituencies need deliberate representation}
\end{frame}
...
% Slide 12a: Summary - The Core Problem
\begin{frame}[t]{Summary: The Hidden Discrimination Problem}
\begin{columns}[T]
\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Why Bias Stays Hidden}}

\small
\textcolor{mlorange}{\textbf{1. Invisibility}}
\begin{itemize}
\item Discrimination embedded in outcomes
\item No ground truth counterfactuals
\item Proxy variables conceal true bias
\end{itemize}

\vspace{0.3cm}
\textcolor{mlblue}{\textbf{2. Measurement Bottleneck}}
\begin{itemize}
\item 490,140 subgroups (6 attributes)
\item Only 4.2 of 21.2 bits measurable
\item 99.996\% of intersections unmeasured
\end{itemize}

\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{How Bias Grows}}

\small
\textcolor{mlpurple}{\textbf{3. Amplification}}
\begin{itemize}
...
\vspace{0.3cm}
\textcolor{mlorange}{\textbf{4. Intersectionality}}
\begin{itemize}
\item Exponential subgroup growth
\item 188M+ samples needed for full coverage
\item Most vulnerable groups unmeasurable
\end{itemize}
\end{columns}

\vspace{0.5em}
\begin{tcolorbox}[colback=mllavender!30, colframe=mlpurple]
\textbf{Core Problem:} I(D; A) > 0 but unobservable - 17 bits of discrimination information lost to measurement limits
\end{tcolorbox}
...
% Slide 12b: Summary - The Stakes and Call to Action
\begin{frame}[t]{Summary: The Urgent Stakes of Hidden Bias}
\begin{columns}[T]
\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{2024 Documented Impact}}

\small
\begin{itemize}
\item 233 AI discrimination incidents
\item 6.2M people affected
\item \$10.4B in documented costs
\item 47 countries impacted
\end{itemize}

\vspace{0.3cm}
\textcolor{mlorange}{\textbf{Systemic Disparities}}
\begin{itemize}
\item 34x error rate: facial recognition
\item 1.8x callback gap: hiring
\item \$2,500 less: healthcare spending
\item 2.1x false positive: recidivism
\end{itemize}

\column{0.48\textwidth}
\textcolor{mlpurple}{\textbf{Power Imbalances}}

\small
\begin{itemize}
\item Tech companies control design
\item Marginalized groups lack voice
\item Powerless bear the harm
\item Future generations inherit bias debt
\end{itemize}
...
\textbf{before} harm occurs
\end{columns}

\vspace{0.5em}
\begin{tcolorbox}[colback=mllavender!30, colframe=mlpurple]
\textbf{Next:} Part 2 explores measurement frameworks - demographic parity, equal opportunity, and more
\end{tcolorbox}

\bottomnote{Harm acceleration outpaces detection - measurement infrastructure becomes critical as AI deployment scales}
\end{frame}
